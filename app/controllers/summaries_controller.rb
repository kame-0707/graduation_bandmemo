    ...
    response = client.chat(
        parameters: {
            ...
            messages: [
                ...
                { role: "user", content: "以下のコンテンツを、マークダウンでわかりやすくまとめてください。小見出しは必ず番号付きで、必ず番号から小見出しを**で囲んで太字にしてください。小見出しの数が少なすぎないように注意し、内容は箇条書きで簡潔にまとめてください。#{summary_params[:content]}" },
            ],
        })
